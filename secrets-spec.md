...
Статус: черновик к реализации. Дата: 2026-09-14 (rev 2). Автор спеки: Hermes, исполнитель: пользователь (свой код).
...
- Go 1.27 (на боксе есть: `~/apps/go/go/bin/go`, в PATH через `~/apps/go/bin`).
